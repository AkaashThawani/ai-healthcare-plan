...
export function PatientForm({ onSubmit, isLoading }: PatientFormProps) {
  ...
  const handleArrayAdd = (
    field: keyof PatientInput,
    value: string,
    tempField: keyof typeof tempInputs,
  ) => {
  ...
  const handleMedicationAdd = () => {
    const { medicationName, medicationDosage, medicationFrequency } =
      tempInputs;
    if (
      !medicationName.trim() ||
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                {formData.comorbidities.map((item, idx) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() => handleArrayRemove("comorbidities", idx)}
      ...
      <div>
        ...
        <div className="flex gap-2">
          <input
            ...
            onChange={(e) =>
              setTempInputs((prev) => ({ ...prev, allergy: e.target.value }))
            }
            onKeyPress={(e) =>
              e.key === "Enter" &&
              (e.preventDefault(),
              handleArrayAdd("allergies", tempInputs.allergy, "allergy"))
            }
            className="form-input"
            ...
            <div className="flex gap-2">
              <input
                ...
                onKeyPress={(e) =>
                  e.key === "Enter" &&
                  (e.preventDefault(),
                  handleArrayAdd("symptoms", tempInputs.symptom, "symptom"))
                }
                className="form-input"
                ...
                {formData.fall_risk_factors.map((item, idx) => (
                  ...
                  >
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        handleArrayRemove("fall_risk_factors", idx)
                      }
